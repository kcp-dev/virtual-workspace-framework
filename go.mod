...
require (
	...
	github.com/kcp-dev/sdk v0.0.0-20260522103534-1aa5106a17db
...
replace (
	github.com/kcp-dev/apimachinery/v2 => github.com/kcp-dev/apimachinery/v2 v2.0.0-20260513141322-0f0714fad9ea
