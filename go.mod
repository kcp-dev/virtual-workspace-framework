...
require (
	...
	github.com/kcp-dev/sdk v0.0.0-20260601102533-eaffc0ef80d4
...
replace (
	...
	k8s.io/cri-streaming => github.com/kcp-dev/kubernetes/staging/src/k8s.io/cri-streaming v0.0.0-20260513103013-2d7bf6b3c556
...
replace (
	github.com/kcp-dev/apimachinery/v2 => github.com/kcp-dev/apimachinery/v2 v2.0.0-20260528111109-3fda4dbfbbc9
	github.com/kcp-dev/client-go => github.com/kcp-dev/client-go v0.0.0-20260522103404-5046253cbd4d
)
