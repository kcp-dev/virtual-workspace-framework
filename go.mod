...
require (
	...
	github.com/kcp-dev/sdk v0.0.0-20260720171546-9d5bd743086c
...
replace (
	github.com/kcp-dev/apimachinery/v2 => github.com/kcp-dev/apimachinery/v2 v2.0.0-20260615094100-229dbedddc96
