...
require (
	...
	github.com/kcp-dev/sdk v0.0.0-20260602092522-8f173bbf6767
...
replace (
	github.com/kcp-dev/apimachinery/v2 => github.com/kcp-dev/apimachinery/v2 v2.0.0-20260601135543-39a3c2719b26
